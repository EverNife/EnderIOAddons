...
public class HandleSetBlockCoord implements IHandler<Set<BlockCoord>> {
    ...
    public boolean store(@Nonnull Registry registry, @Nonnull Set<StoreFor> phase, @Nonnull NBTTagCompound nbt,
        @Nonnull String name, @Nonnull Set<BlockCoord> object)
    ...
    @Override
    public Set<BlockCoord> read(@Nonnull Registry registry, @Nonnull Set<StoreFor> phase, @Nonnull NBTTagCompound nbt,
        @Nonnull String name, @Nullable Set<BlockCoord> object)
        throws IllegalArgumentException, IllegalAccessException, InstantiationException, NoHandlerFoundException {
