...
public class TeaserRecipeHandler extends TemplateRecipeHandler {
    ...
    private TeaserRecipe tryToMakeARecipe(ItemStack itemstack, int pageid) {
        if (itemstack != null && itemstack.getItem() != null) {
            final String unlocalizedName = itemstack.getItem()
    ...
    public void drawBackground(int recipe) {
        if (((TeaserRecipe) arecipes.get(recipe)).texture != null) {
            String texture = EnderIOAddons.DOMAIN + ":textures/gui/"
                + ((TeaserRecipe) arecipes.get(recipe)).texture
                + ".png";
    ...
    public void drawExtras(int recipeIndex) {
        if (((TeaserRecipe) arecipes.get(recipeIndex)).textKey != null) {
            GuiDraw.fontRenderer.drawSplitString(
                EnderIOAddons.lang.localize(((TeaserRecipe) arecipes.get(recipeIndex)).textKey),
                5,
                16 + 18 + 6 - yOff,
                160,
