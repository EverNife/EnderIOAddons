...
public class Recipes implements InitAware {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        if (isAnyFrameworkMachineEnabled()) {
            ItemStack machineFrame = new ItemStack(
                ItemMachinePart.itemMachinePart,
                1,
                MachinePart.MACHINE_FRAME.ordinal());
            addShaped(machineFrame, "dsd", "s s", "dsd", 's', electricSteel, 'd', darkSteel);

            if (isAnyFrameworkMachineWithTanksEnabled()) {
                ItemStack frameTank = new ItemStack(
                    ItemMachinePart.itemMachinePart,
                    1,
                    MachinePart.FRAME_TANK.ordinal());
                addShaped(frameTank, "scs", "c c", "scs", 's', silicon, 'c', clearGlass);

                ItemStack frameTanks = new ItemStack(
                    ItemMachinePart.itemMachinePart,
                    1,
                    MachinePart.FRAME_TANKS.ordinal());
                addShapeless(frameTanks, frameTank, frameTank, frameTank, frameTank);

                ItemStack machineFrameTank = new ItemStack(
                    ItemMachinePart.itemMachinePart,
                    1,
                    MachinePart.MACHINE_FRAME_TANK.ordinal());
                ...
                if (Config.cobbleWorksEnabled.getBoolean()) {
                    ItemStack cobbleController = new ItemStack(
                        ItemMachinePart.itemMachinePart,
                        1,
                        MachinePart.COBBLE_CONTROLLER.ordinal());
                    addShaped(
                        cobbleController,
                        "sis",
                        "lMw",
                ...
                if (Config.waterWorksEnabled.getBoolean()) {
                    ItemStack heatingElement = new ItemStack(
                        ItemMachinePart.itemMachinePart,
                        1,
                        MachinePart.HEATING_ELEMENT.ordinal());
                    addShaped(
                        heatingElement,
                        "ccs",
                        "srs",
                    ...
                    ItemStack filterElement = new ItemStack(
                        ItemMachinePart.itemMachinePart,
                        1,
                        MachinePart.FILTER_ELEMENT.ordinal());
                    addShaped(filterElement, "bbb", "ccc", "bbb", 'b', darkSteelBars, 'c', binderComposite);

                    ItemStack waterController = new ItemStack(
                        ItemMachinePart.itemMachinePart,
                        1,
                        MachinePart.WATER_CONTROLLER.ordinal());
                    addShaped(
                        waterController,
                        "sis",
                        "fMf",
                ...
                if (Config.tcomEnabled.getBoolean()) {
                    ...
                    ItemStack pylontank = new ItemStack(
                        ItemMachinePart.itemMachinePart,
                        1,
                        MachinePart.PYLONTANK.ordinal());
                    addShapeless(pylontank, frameTank, pylon);

                    ItemStack tcomController = new ItemStack(
                        ItemMachinePart.itemMachinePart,
                        1,
                        MachinePart.TCOM_CONTROLLER.ordinal());
                    addShaped(
                        tcomController,
                        "sCs",
                        "pMa",
            ...
            if (Config.impulseHopperEnabled.getBoolean()) {
                ItemStack ihopperController = new ItemStack(
                    ItemMachinePart.itemMachinePart,
                    1,
                    MachinePart.IHOPPER_CONTROLLER.ordinal());
                addShaped(
                    ihopperController,
                    "sis",
                    "hMt",
        ...
        if (farmEnabled || Config.flagEnabled.getBoolean()
            ...
            ItemStack chassiParts = new ItemStack(
                ItemMachinePart.itemMachinePart,
                8,
                MachinePart.CHASSIPARTS.ordinal());
            ...
            if (Config.flagEnabled.getBoolean() || Config.magcEnabled.getBoolean()) {
                ItemStack simpleMagnet = new ItemStack(
                    ItemMachinePart.itemMachinePart,
                    2,
                    MachinePart.SIMPLEMAGNET.ordinal());
                addShaped(simpleMagnet, "ccc", "c c", "s s", 's', electricSteel, 'c', conductiveIron);

                // Magnetic Flag
                if (Config.flagEnabled.getBoolean()) {
                    ItemStack flagParts = new ItemStack(
                        ItemMachinePart.itemMachinePart,
                        8,
                        MachinePart.FLAGPARTS.ordinal());
                    addShaped(
                        flagParts,
                        "sRR",
                        "sRR",
            ...
            if (farmEnabled) {
                ...
                ItemStack moduleBase = new ItemStack(
                    ItemMachinePart.itemMachinePart,
                    1,
                    MachinePart.FCM_BASE.ordinal());
                ...
                ItemStack brokenRakeWood = new ItemStack(
                    ItemMachinePart.itemMachinePart,
                    1,
                    MachinePart.RAKE_BR1.ordinal());
                ItemStack brokenRakeIron = new ItemStack(
                    ItemMachinePart.itemMachinePart,
                    1,
                    MachinePart.RAKE_BR2.ordinal());
                ...
                ItemStack HARVESTUNANALYZED = new ItemStack(
                    ItemModule.itemModule,
                    1,
                    Module.HARVESTUNANALYZED.ordinal());
    ...
    private static boolean isAnyFrameworkMachineEnabled() {
        return Config.cobbleWorksEnabled.getBoolean() || Config.waterWorksEnabled.getBoolean()
            || Config.impulseHopperEnabled.getBoolean()
