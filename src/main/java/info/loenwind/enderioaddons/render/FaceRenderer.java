...
public class FaceRenderer {
  ...
  // @formatter:on
    ...
    public static void renderCube(BoundingBox bb, IIcon[] icons, VertexTransform xForm, float[] brightnessPerSide,
        boolean inside) {
    ...
    public static void renderCube(BoundingBox bb, IIcon tex, VertexTransform xForm, float[] brightnessPerSide,
        boolean inside) {
        setupVertices(bb, xForm);
        if (tex != null) {
            float minU = tex.getMinU();
    ...
    private final static ForgeDirection[] AROUND = { ForgeDirection.NORTH, ForgeDirection.SOUTH, ForgeDirection.EAST,
        ForgeDirection.WEST };

    public static void renderSkirt(BoundingBox bb, IIcon[] icons, double texMinU, double texMaxU, double texMinV,
        double texMaxV, VertexTransform xForm, float[] brightnessPerSide, boolean inside) {
    ...
    public static void renderSkirt(BoundingBox bb, IIcon tex, double texMinU, double texMaxU, double texMinV,
        double texMaxV, VertexTransform xForm, float[] brightnessPerSide, boolean inside) {
        if (tex != null) {
            for (ForgeDirection face : AROUND) {
                renderSingleFace(bb, face, tex, texMinU, texMaxU, texMinV, texMaxV, xForm, brightnessPerSide, inside);
    ...
    public static void renderSkirt(BoundingBox bb, IIcon[] icons, VertexTransform xForm, float[] brightnessPerSide,
        boolean inside) {
        for (ForgeDirection face : AROUND) {
            IIcon tex = icons[face.ordinal()];
            if (tex != null) {
    ...
    public static void renderSkirt(BoundingBox bb, IIcon tex, VertexTransform xForm, float[] brightnessPerSide,
        boolean inside) {
        if (tex != null) {
            for (ForgeDirection face : AROUND) {
                renderSingleFace(bb, face, tex, 0, 16, 0, 16, xForm, brightnessPerSide, inside);
    ...
    public static void renderSingleFace(BoundingBox bb, ForgeDirection face, IIcon[] icons, VertexTransform xForm,
    ...
    public static void renderSingleFace(BoundingBox bb, ForgeDirection face, IIcon[] icons, double texMinU,
        double texMaxU, double texMinV, double texMaxV, VertexTransform xForm, float[] brightnessPerSide,
        boolean inside) {
        IIcon tex = icons[face.ordinal()];
        if (tex != null) {
            renderSingleFace(bb, face, tex, texMinU, texMaxU, texMinV, texMaxV, xForm, brightnessPerSide, inside);
    ...
    public static void renderSingleFace(BoundingBox bb, ForgeDirection face, IIcon tex, double texMinU, double texMaxU,
        double texMinV, double texMaxV, VertexTransform xForm, float[] brightnessPerSide, boolean inside) {
        setupVertices(bb, xForm);
    ...
    public static void renderSingleFace(BoundingBox bb, ForgeDirection face, IIcon tex, VertexTransform xForm,
        float[] brightnessPerSide, boolean inside) {
        setupVertices(bb, xForm);
        float minU = tex.getMinU();
        float maxU = tex.getMaxU();
    ...
    public static void renderSingleFace(ForgeDirection face, float minU, float maxU, float minV, float maxV,
