...
public class Manager implements InitAware {
    ...
    public void init(FMLPreInitializationEvent event) {
        PacketHandler.INSTANCE
            .registerMessage(PacketParticles.class, PacketParticles.class, PacketHandler.nextID(), Side.CLIENT);
        PacketHandler.INSTANCE.registerMessage(
            ...
            Side.SERVER);
        PacketHandler.INSTANCE.registerMessage(
            PacketNetworkUpdate.HandleNetworkUpdateClient.class,
            PacketNetworkUpdate.class,
            PacketHandler.nextID(),
            Side.CLIENT);
        PacketHandler.INSTANCE.registerMessage(
            PacketNetworkUpdate.HandleNetworkUpdateServer.class,
            PacketNetworkUpdate.class,
            PacketHandler.nextID(),
            Side.SERVER);
    }
            ...
            for (Entry<INetworkUpdatable, Integer> entry : networkUpdatables.entrySet()) {
                ...
                if (te != null) {
                    ...
                    if (i-- <= 0) {
                        ...
                        if (needUpdate) {
                            PacketHandler
                                .sendToAllAround(new PacketNetworkUpdate((TileEntity) te, data), (TileEntity) te);
                        }
