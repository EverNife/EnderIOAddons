...
public class PacketParticles implements IMessage, IMessageHandler<PacketParticles, IMessage> {
    ...
    public static void spawnParticle(World world, String particle, BlockCoord bc, double velx, double vely,
        double velz) {
        PacketHandler.INSTANCE.sendToAllAround(
            new PacketParticles(particle, bc.x, bc.y, bc.z, velx, vely, velz),
            new TargetPoint(world.provider.dimensionId, bc.x, bc.y, bc.z, 24));
    }

    public static void spawnParticle(World world, String particle, double x, double y, double z, double velx,
        double vely, double velz) {
        PacketHandler.INSTANCE.sendToAllAround(
            new PacketParticles(particle, x, y, z, velx, vely, velz),
            new TargetPoint(world.provider.dimensionId, x, y, z, 24));
    }
