...
public class BlockPMon extends AbstractMachineBlock<TilePMon> implements IAdvancedTooltipProvider {
    ...
    public static final ModObject ModObject_blockPMon = EnumHelper
        .addEnum(ModObject.class, "blockPMon", new Class<?>[0], new Object[0]);
    public static BlockPMon blockPMon;
    public int localRenderId;

    public static BlockPMon create() {
        PacketHandler.INSTANCE
            .registerMessage(PacketPMon.ClientHandler.class, PacketPMon.class, PacketHandler.nextID(), Side.CLIENT);
        PacketHandler.INSTANCE
            .registerMessage(PacketPMon.ServerHandler.class, PacketPMon.class, PacketHandler.nextID(), Side.SERVER);
