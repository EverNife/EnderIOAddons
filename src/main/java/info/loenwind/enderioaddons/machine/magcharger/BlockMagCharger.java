...
public class BlockMagCharger extends AbstractMachineBlock<TileMagCharger> {
    ...
    public static final ModObject ModObject_blockMagCharger = EnumHelper
        .addEnum(ModObject.class, "blockMagCharger", new Class<?>[0], new Object[0]);
    ...
    public void registerBlockIcons(IIconRegister iIconRegister) {
        ...
        iconBuffer[1][8] = new IconFlipped(
            iIconRegister.registerIcon(EnderIOAddons.DOMAIN + ":chargerBar"),
            true,
            false);
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int blockSide) {
        ...
        if (blockSide <= 5) {
            ...
            return iconBuffer[isActive(world, x, y, z) ? 1
                : 0][ClientProxy.sideAndFacingToSpriteOffset[blockSide][facing]];
        } else {
