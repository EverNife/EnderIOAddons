...
public class BlockFlag extends BlockEio implements IAdvancedTooltipProvider, IWailaInfoProvider {
    ...
    public static final ModObject ModObject_blockFlag = EnumHelper
        .addEnum(ModObject.class, "blockFlag", new Class<?>[0], new Object[0]);
    ...
    public void registerBlockIcons(IIconRegister iIconRegister) {
        ...
        icons[2] = icons[3] = icons[4] = icons[5] = iIconRegister
            .registerIcon(EnderIOAddons.DOMAIN + ":blockFlagBaseSide");
        icons[6] = icons[7] = iIconRegister.registerIcon(EnderIOAddons.DOMAIN + ":blockFlagMast");
        icons[8] = icons[9] = icons[10] = icons[11] = iIconRegister
            .registerIcon(EnderIOAddons.DOMAIN + ":blockFlagBaseSideOffline");
    }
