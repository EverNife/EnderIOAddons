...
public enum MachinePart {
    ...
    private MachinePart(@Nonnull String unlocalisedName, boolean render3d, boolean renderAsFrameMachine,
        boolean hasFrame, @Nullable String controllerModelName, boolean hasTanks, boolean hasSingleTank,
        boolean isAgricraftPart) {
