...
public enum Mats {
    ...
    STICK(Items.stick, Blocks.planks),
    STRING(Items.string, null),
    LEATHER(Items.leather, null),
    WOOD(Blocks.planks),
    COBBLE(Blocks.cobblestone),
    IRON(Items.iron_ingot, Blocks.iron_block),
    GOLD(Items.gold_ingot, Blocks.gold_block),
    DIAMOND(Items.diamond, Blocks.diamond_block),
    ...
    public boolean isSame(ItemStack itemstack) {
        return itemstack != null && itemstack.getItem() != null
            && this.itemStack.getItem() == itemstack.getItem()
