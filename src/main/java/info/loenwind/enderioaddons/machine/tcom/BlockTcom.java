...
public class BlockTcom extends AbstractMachineBlock<TileTcom> implements IFrameworkBlock, ITextureProvider {
    ...
    public static final ModObject ModObject_blockTcom = EnumHelper
        .addEnum(ModObject.class, "blockTcom", new Class<?>[0], new Object[0]);
    public static BlockTcom blockTcom;
    public int localRenderId;

    public static BlockTcom create() {
        PacketHandler.INSTANCE
            .registerMessage(PacketTcomAction.class, PacketTcomAction.class, PacketHandler.nextID(), Side.SERVER);
        PacketHandler.INSTANCE
            .registerMessage(PacketTcomUpdate.class, PacketTcomUpdate.class, PacketHandler.nextID(), Side.CLIENT);
