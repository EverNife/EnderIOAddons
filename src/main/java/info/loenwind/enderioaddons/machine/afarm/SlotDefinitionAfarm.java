...
public class SlotDefinitionAfarm extends SlotDefinition {
    ...
    public SlotDefinitionAfarm(int num_control_slots, int num_control_storage_slots, int num_seed_ghost_slots,
        int num_seed_storage_slots, int num_output_slots, int num_tool_slots, int num_fertilizer_slots,
        int num_cropstick_slots, int num_upgrade_slots) {
        super(
            num_control_storage_slots + num_seed_storage_slots
                + num_tool_slots
