...
public class GhostlySlotDefinition extends SlotDefinition {
    ...
    public GhostlySlotDefinition(int minInputSlot, int maxInputSlot, int minOutputSlot, int maxOutputSlot,
        int minUpgradeSlot, int maxUpgradeSlot, int minGhostSlot, int maxGhostSlot) {
