...
public class RedstoneModeState implements IHandler<RedstoneModeState> {
    ...
    @Override
    public boolean store(Registry registry, Set<StoreFor> phase, NBTTagCompound nbt, String name,
        RedstoneModeState object)
    ...
    @Override
    public RedstoneModeState read(Registry registry, Set<StoreFor> phase, NBTTagCompound nbt, String name,
        RedstoneModeState object)
        throws IllegalArgumentException, IllegalAccessException, InstantiationException, NoHandlerFoundException {
